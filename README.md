...
### Details
This application is just a learning exercise in UI implementation. It's just a mockup. It's not using livedata. The list of books uses a pre-written String array of books and percentages.
